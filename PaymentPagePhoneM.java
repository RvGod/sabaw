...
public class PaymentPagePhoneM extends JFrame implements ActionListener{
  String[] names;
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    int onlinePayfee = 
    CODbtn.isSelected() ? 0 :
    cButton2.isSelected() ? 25 :
    cButton1.isSelected() ? 2:
     cButton3.isSelected() ? 2:
    0;
    ...
    JLabel labelsubtotalfee = new JLabel("250", SwingConstants.CENTER);
    JLabel labelshippingfee = new JLabel("FREE", SwingConstants.CENTER);
    JLabel labelPHONE = new JLabel("PHONE MAINTENANCE", SwingConstants.CENTER);
    ...
    labelPHONE.setForeground(colorOrange);
  ...
  public static void main(String[] args) {
    PaymentPagePhoneM p = new PaymentPagePhoneM();
  }
}
