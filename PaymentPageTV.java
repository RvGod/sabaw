...
public class PaymentPageTV extends JFrame implements ActionListener{
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    int onlinePayfee = 
    CODbtn.isSelected() ? 0 :
    cButton2.isSelected() ? 100 :
    cButton1.isSelected() ? 10:
     cButton3.isSelected() ? 10:
    0;
    ...
    JLabel labelsubtotalfee = new JLabel("1000", SwingConstants.CENTER);
    JLabel labelshippingfee = new JLabel("FREE", SwingConstants.CENTER);
    JLabel labelTV = new JLabel("TV REPAIR", SwingConstants.CENTER);
  ...
  public static void main(String[] args) {
    PaymentPageTV p = new PaymentPageTV();
  }
}
