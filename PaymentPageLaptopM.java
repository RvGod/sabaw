...
public class PaymentPageLaptopM extends JFrame implements ActionListener{
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    int onlinePayfee = 
    CODbtn.isSelected() ? 0 :
    cButton2.isSelected() ? 75 :
    cButton1.isSelected() ? 7:
     cButton3.isSelected() ? 7:
    0;
    ...
    JLabel labelsubtotalfee = new JLabel("750", SwingConstants.CENTER);
    JLabel labelshippingfee = new JLabel("FREE", SwingConstants.CENTER);
    JLabel labelLAPTOP = new JLabel("LAPTOP MAINTENANCE", SwingConstants.CENTER);
    ...
    labelLAPTOP.setForeground(colorOrange);
  ...
  public static void main(String[] args) {
    PaymentPageLaptopM p = new PaymentPageLaptopM();
    p.setVisible(true);
  }
}
