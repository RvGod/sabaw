...
public class PaymentPageComputerM extends JFrame implements ActionListener{
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    int onlinePayfee = 
    CODbtn.isSelected() ? 0 :
    cButton2.isSelected() ? 125 :
    cButton1.isSelected() ? 12:
     cButton3.isSelected() ? 12:
    0;
    ...
    JLabel labelsubtotalfee = new JLabel("1250", SwingConstants.CENTER);
    JLabel labelshippingfee = new JLabel("FREE", SwingConstants.CENTER);
    JLabel labelCOMPUTER = new JLabel("COMPUTER MAINTENANCE", SwingConstants.CENTER);
  ...
  public static void main(String[] args) {
    PaymentPageComputerM p = new PaymentPageComputerM();
  }
}
