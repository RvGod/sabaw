...
public class PaymentPagePhone extends JFrame implements ActionListener{
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    int onlinePayfee = 
    CODbtn.isSelected() ? 0 :
    cButton2.isSelected() ? 50 :
    cButton1.isSelected() ? 5:
     cButton3.isSelected() ? 5:
    0;
    ...
    JLabel labelsubtotalfee = new JLabel("500", SwingConstants.CENTER);
    JLabel labelshippingfee = new JLabel("FREE", SwingConstants.CENTER);
    JLabel labelPHONE = new JLabel("PHONE REPAIR", SwingConstants.CENTER);
  ...
  public static void main(String[] args) {
    PaymentPagePhone p = new PaymentPagePhone();
  }
}
