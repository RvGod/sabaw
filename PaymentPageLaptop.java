...
public class PaymentPageLaptop extends JFrame implements ActionListener{
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    int onlinePayfee = 
    CODbtn.isSelected() ? 0 :
    cButton2.isSelected() ? 150 :
    cButton1.isSelected() ? 15:
     cButton3.isSelected() ? 15:
    0;
    ...
    JLabel labelsubtotalfee = new JLabel("1500", SwingConstants.CENTER);
    JLabel labelshippingfee = new JLabel("FREE", SwingConstants.CENTER);
    JLabel labelLAPTOP = new JLabel("LAPTOP REPAIR", SwingConstants.CENTER);
  ...
  public static void main(String[] args) {
    PaymentPageLaptop p = new PaymentPageLaptop();
  }
}
