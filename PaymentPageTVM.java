...
public class PaymentPageTVM extends JFrame implements ActionListener{
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    JLabel labelTV = new JLabel("TV MAINTENANCE", SwingConstants.CENTER);
    ...
    labelTV.setForeground(colorOrange);
  ...
  public static void main(String[] args) {
    PaymentPageTVM p = new PaymentPageTVM();
  }
}
